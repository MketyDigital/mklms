...
import { AdminMediaUpload } from "@/features/media/components/admin-media-upload";
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Upload private MP4 videos to configured storage or register an existing provider reference. Courses and live classes reuse the same protected media records.
          </p>
        </div>
