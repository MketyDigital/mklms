    ...
    return NextResponse.json(
      {
        ...
        message: "Hosted-video registration is temporarily restricted because a managed hosting payment is overdue. Payment confirmation restores uploads automatically.",
      },
      { status: 402 },
    );
  }
