...
export class PostgresSettingsRepository implements SettingsRepository {
  ...
  async savePlatformSettings(settings: PlatformSettings): Promise<void> {
    await this.pool.query(`INSERT INTO platform_settings (
         ...
         email_provider, notification_provider, access_code_prefix, certificate_prefix
       ...
       ON CONFLICT (id) DO UPDATE SET
         ...
         access_code_prefix=EXCLUDED.access_code_prefix, certificate_prefix=EXCLUDED.certificate_prefix, updated_at=NOW()`, [
